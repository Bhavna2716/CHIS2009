#List of all loaded and installed packages 
...
#Locally loaded chis2009 adult file into R studio (Not part of the datacamp exercise as the file 
#was already loaded there)
library(haven)
adult <- read_sas("C:/Users/Bhavna/Desktop/Data_Science/chis2009/adult.sas7bdat")
